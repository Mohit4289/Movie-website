...
const More = () => {
  return (
    <div className=" mt-10 mb-10">
      <h1 className="head ml-[8%] text-2xl font-bold">More reasons to join</h1>
      <div className="more flex justify-center  gap-6 mt-[30px]">
        <div className="item">
          ...
          <svg width="72" height="72" viewBox="0 0 72 72" fill="none" className="mt-[120px] ml-[130px]">
        ...
        <div className="item">
          ...
          <svg width="72" height="72" viewBox="0 0 72 72" fill="none" className="mt-[70px] ml-[130px]">
        ...
        <div className="item">
          ...
          <svg width="72" height="72" viewBox="0 0 72 72" fill="none" className="mt-[147px] ml-[130px]">
        ...
        <div className="item">
          ...
          <svg width="72" height="72" viewBox="0 0 72 72" fill="none" className="mt-[90px] ml-[130px]">
      ...
      <h1 className=" text-center text-2xl font-bold mt-10">Ready to watch? Enter your email to create or restart your membership.</h1>
      <div className="address flex justify-center gap-5">
        <input type="email"  placeholder="Email address" className="p-4 bg-black text-white rounded-md mt-4 w-[400px]"/>
        <button type="submit" className="p-4 bg-red-600 text-center mt-4 text-white text-2xl font-bold rounded-md h-[60px]">Get Started</button>
      </div>
    </div>
  );
};
